%% @begin TensorExplorationPARAFAC
...
%% @begin CreatingMatrix 
%% @desc Creating a matrix of characteristics
%%{
...
%% @desc normalizing mother characteristics by column
